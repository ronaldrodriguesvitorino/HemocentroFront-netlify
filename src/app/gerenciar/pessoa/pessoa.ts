...
export class Pessoa {
  ...
  listar(): void {
    this.http.get<any[]>('https://hemocentroback.onrender.com/pessoa').subscribe({
      next: (resposta) => {
  ...
  buscar(): void {
    ...
    this.http.get('https://hemocentroback.onrender.com/pessoa/' + this.idBusca).subscribe({
      next: (resposta) => {
        this.busca = resposta;
        this.cdr.detectChanges();
      },
  ...
  criar(): void {
    ...
    this.http.post('https://hemocentroback.onrender.com/pessoa', request).subscribe({
      next: (resposta) => {
  ...
  editar(): void {
    ...
    this.http.put('https://hemocentroback.onrender.com/pessoa/' + this.idBusca, request).subscribe({
      next: (resposta) => {
  ...
  deletarComConfirmacao(id: number, nome: string): void {
    ...
    if (confirmou) {
      this.http.delete('https://hemocentroback.onrender.com/pessoa/' + id).subscribe({
        next: (resposta) => {
